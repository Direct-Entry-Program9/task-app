...
public class TaskController {
    ...
    public TaskDTO createNewTask(@RequestBody @Validated(ValidationGroup.Create.class) TaskDTO taskDTO,
                                 @RequestAttribute String username, @PathVariable int projectId){
    ...
    public void renameTask(@RequestBody @Validated(ValidationGroup.Update.class) TaskDTO taskDTO,
                           @RequestAttribute String username, @PathVariable int projectId,
    ...
    public void deleteTask(@RequestAttribute String username, @PathVariable int projectId,
                           @PathVariable int taskId){
    ...
    public TaskDTO getTaskDetails(@RequestAttribute String username, @PathVariable int projectId,
                               @PathVariable int taskId){
    ...
    public void updateTaskStatus(@RequestAttribute String username, @PathVariable int projectId,
                                 @PathVariable int taskId, @RequestParam boolean completed){
